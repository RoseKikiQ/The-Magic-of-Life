...
@export var item_id: String = "Earth"
...
func _on_earth_area_entered(area: Area2D) -> void:
	print("Touched:", area.name)
	if area.name == "Metal":
		print("Hit Metal!")
		$"../Earth/UntitledArtwork(8)".hide()
		$"UntitledArtwork(10)".hide()
		area.get_node("UntitledArtwork(13)").show()
...
func _on_fire_area_entered(area: Area2D) -> void:
	...
	if area.name == "Metal":
		print("Hit Metal!")
		$"../Fire/UntitledArtwork(7)".hide()
		$"UntitledArtwork(10)".hide()
		area.get_node("UntitledArtwork(20)").show()
